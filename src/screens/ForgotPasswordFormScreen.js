...
export default class ForgotPasswordFormScreen extends Component {
    ...
    render () {
        ...
        return (
            <View style={{flex: 1, alignItems: 'center'}}>
                ...
                <Header
                    leftComponent={{ icon: "arrow-left", type: 'font-awesome', color: '#fff' }}
                ...
                <View style={{flex: 1, width: wp("85%"), justifyContent: "center"}}>
                    ...
                    <View style={{flexDirection:"row", alignItems: "center", justifyContent: "center"}}>
                        ...
                        <Button title={"Login"} type={"clear"} titleStyle={{color: "black "}} />
                    </View>
                </View>
            </View>
        )
