                                        ...
                                        <TouchableOpacity
                                            ...
                                            style={{justifyContent: "flex-end"}}>
                                            {
                                                item.selected ?
                                                    ...
                                                    <Text
                                                        style={[screenStyles.categorySliderActiveText, index === 0 && {marginLeft: 0}]}>{item.primaryTitle}</Text>
                                                    :
                                                    <Text
                                                        style={screenStyles.categorySliderInActiveText}>{item.primaryTitle}</Text>
                                ...
                                <View style={screenStyles.categoryFoodItemParent}>

                                    {
                                        categoryFoodItemList.map((item, index) => {
                                            return <View
                                                key={index}
                                                style={screenStyles.categoryFoodItem}
                                            >
                                                <FoodItem
                                                    title={item.title}
                                                    image={item.image}
