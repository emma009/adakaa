...
import {ImageBackground, StatusBar, TouchableOpacity, TouchableWithoutFeedback, View,} from 'react-native';
...
export default class LoginScreen extends Component {
    ...
    render () {
        ...
        return (
            <ImageBackground source={assets.login_header3} style={{flex: 1, alignItems: 'center', backgroundColor: colors.textColorGrey2}} resizeMode={"cover"}>
